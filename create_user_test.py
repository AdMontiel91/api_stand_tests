...
def get_user_body(first_name):# Función de prueba positiva
...
#Funcion auxiliar para pruebas positivas:
...
#Funcion auxiliar para pruebas negativas (1):
...
# Prueba 3. Error
# El parámetro "firstName" contiene solo un caracter
...
#Funcion auxiliar para pruebas negativas (2):
...
# Prueba 10. Error
#E l tipo del parámetro "firstName" es un número
